...
type glVertex_Array struct {
	Vertex_attribs [16]glVertex_Attrib
...
func cvec_glVertex_Array_heap(size uint64, capacity uint64) *cvector_glVertex_Array {
	...
	if (func() *glVertex_Array {
		p := &vec.A
		vec.A = (*glVertex_Array)(libc.Malloc(int(vec.Capacity * uint64(unsafe.Sizeof(glVertex_Array{})))))
		return *p
	}()) == nil {
...
func cvec_init_glVertex_Array_heap(vals *glVertex_Array, num uint64) *cvector_glVertex_Array {
	...
	libc.MemMove(unsafe.Pointer(vec.A), unsafe.Pointer(vals), int(num*uint64(unsafe.Sizeof(glVertex_Array{}))))
	return vec
}
...
func cvec_copy_glVertex_Array(dest *cvector_glVertex_Array, src *cvector_glVertex_Array) int64 {
	...
	if (func() *glVertex_Array {
		tmp = (*glVertex_Array)(libc.Realloc(unsafe.Pointer(dest.A), int(src.Capacity*uint64(unsafe.Sizeof(glVertex_Array{})))))
		return tmp
	}()) == nil {
		libc.Assert(tmp != nil)
		return 0
	...
	dest.A = tmp
	libc.MemMove(unsafe.Pointer(dest.A), unsafe.Pointer(src.A), int(src.Size*uint64(unsafe.Sizeof(glVertex_Array{}))))
	dest.Size = src.Size
...
func cvec_push_glVertex_Array(vec *cvector_glVertex_Array, a glVertex_Array) int64 {
	...
	if vec.Capacity > vec.Size {
		*(*glVertex_Array)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glVertex_Array{})*uintptr(func() uint64 {
			p := &vec.Size
			x := *p
			*p++
			return x
		...
		if (func() *glVertex_Array {
			tmp = (*glVertex_Array)(libc.Realloc(unsafe.Pointer(vec.A), int(tmp_sz*uint64(unsafe.Sizeof(glVertex_Array{})))))
			return tmp
		}()) == nil {
			libc.Assert(tmp != nil)
			return 0
...
func cvec_pop_glVertex_Array(vec *cvector_glVertex_Array) glVertex_Array {
	return *(*glVertex_Array)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glVertex_Array{})*uintptr(func() uint64 {
		p := &vec.Size
		*p--
		return *p
	}())))
...
func cvec_back_glVertex_Array(vec *cvector_glVertex_Array) *glVertex_Array {
	return (*glVertex_Array)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glVertex_Array{})*uintptr(vec.Size-1)))
}
...
func cvec_insert_glVertex_Array(vec *cvector_glVertex_Array, i uint64, a glVertex_Array) int64 {
	...
	if vec.Capacity > vec.Size {
		libc.MemMove(unsafe.Pointer((*glVertex_Array)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glVertex_Array{})*uintptr(i+1)))), unsafe.Pointer((*glVertex_Array)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glVertex_Array{})*uintptr(i)))), int((vec.Size-i)*uint64(unsafe.Sizeof(glVertex_Array{}))))
		*(*glVertex_Array)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glVertex_Array{})*uintptr(i))) = a
	} else {
		tmp_sz = (vec.Capacity + 1) * 2
		if (func() *glVertex_Array {
			tmp = (*glVertex_Array)(libc.Realloc(unsafe.Pointer(vec.A), int(tmp_sz*uint64(unsafe.Sizeof(glVertex_Array{})))))
...
func cvec_insert_array_glVertex_Array(vec *cvector_glVertex_Array, i uint64, a *glVertex_Array, num uint64) int64 {
	...
	libc.MemMove(unsafe.Pointer((*glVertex_Array)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glVertex_Array{})*uintptr(i+num)))), unsafe.Pointer((*glVertex_Array)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glVertex_Array{})*uintptr(i)))), int((vec.Size-i)*uint64(unsafe.Sizeof(glVertex_Array{}))))
	libc.MemMove(unsafe.Pointer((*glVertex_Array)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glVertex_Array{})*uintptr(i)))), unsafe.Pointer(a), int(num*uint64(unsafe.Sizeof(glVertex_Array{}))))
	vec.Size += num
	return 1
}
func cvec_replace_glVertex_Array(vec *cvector_glVertex_Array, i uint64, a glVertex_Array) glVertex_Array {
	var tmp glVertex_Array = *(*glVertex_Array)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glVertex_Array{})*uintptr(i)))
	*(*glVertex_Array)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glVertex_Array{})*uintptr(i))) = a
	return tmp
}
func cvec_erase_glVertex_Array(vec *cvector_glVertex_Array, start uint64, end uint64) {
	var d uint64 = end - start + 1
	libc.MemMove(unsafe.Pointer((*glVertex_Array)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glVertex_Array{})*uintptr(start)))), unsafe.Pointer((*glVertex_Array)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glVertex_Array{})*uintptr(end+1)))), int((vec.Size-1-end)*uint64(unsafe.Sizeof(glVertex_Array{}))))
	vec.Size -= d
}
func cvec_reserve_glVertex_Array(vec *cvector_glVertex_Array, size uint64) int64 {
	...
	if vec.Capacity < size {
		if (func() *glVertex_Array {
			tmp = (*glVertex_Array)(libc.Realloc(unsafe.Pointer(vec.A), int((size+CVEC_glVertex_Array_SZ)*uint64(unsafe.Sizeof(glVertex_Array{})))))
			return tmp
		}()) == nil {
			libc.Assert(tmp != nil)
			return 0
...
func cvec_set_cap_glVertex_Array(vec *cvector_glVertex_Array, size uint64) int64 {
	...
	if (func() *glVertex_Array {
		tmp = (*glVertex_Array)(libc.Realloc(unsafe.Pointer(vec.A), int(size*uint64(unsafe.Sizeof(glVertex_Array{})))))
		return tmp
	}()) == nil {
		libc.Assert(tmp != nil)
		return 0
...
func cvec_set_val_sz_glVertex_Array(vec *cvector_glVertex_Array, val glVertex_Array) {
	...
	for i = 0; i < vec.Size; i++ {
		*(*glVertex_Array)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glVertex_Array{})*uintptr(i))) = val
	}
}
...
func cvec_glBuffer_heap(size uint64, capacity uint64) *cvector_glBuffer {
	...
	if (func() *glBuffer {
		p := &vec.A
		vec.A = (*glBuffer)(libc.Malloc(int(vec.Capacity * uint64(unsafe.Sizeof(glBuffer{})))))
		return *p
	}()) == nil {
		libc.Assert(vec.A != nil)
		libc.Free(unsafe.Pointer(vec))
...
func cvec_init_glBuffer_heap(vals *glBuffer, num uint64) *cvector_glBuffer {
	...
	libc.MemMove(unsafe.Pointer(vec.A), unsafe.Pointer(vals), int(num*uint64(unsafe.Sizeof(glBuffer{}))))
	return vec
}
...
func cvec_copy_glBuffer(dest *cvector_glBuffer, src *cvector_glBuffer) int64 {
	...
	if (func() *glBuffer {
		tmp = (*glBuffer)(libc.Realloc(unsafe.Pointer(dest.A), int(src.Capacity*uint64(unsafe.Sizeof(glBuffer{})))))
		return tmp
	}()) == nil {
		libc.Assert(tmp != nil)
		return 0
	...
	dest.A = tmp
	libc.MemMove(unsafe.Pointer(dest.A), unsafe.Pointer(src.A), int(src.Size*uint64(unsafe.Sizeof(glBuffer{}))))
	dest.Size = src.Size
	dest.Capacity = src.Capacity
	return 1
}
func cvec_push_glBuffer(vec *cvector_glBuffer, a glBuffer) int64 {
	...
	if vec.Capacity > vec.Size {
		*(*glBuffer)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glBuffer{})*uintptr(func() uint64 {
			p := &vec.Size
			x := *p
			*p++
			return x
		...
		tmp_sz = (vec.Capacity + 1) * 2
		if (func() *glBuffer {
			tmp = (*glBuffer)(libc.Realloc(unsafe.Pointer(vec.A), int(tmp_sz*uint64(unsafe.Sizeof(glBuffer{})))))
			return tmp
		}()) == nil {
			libc.Assert(tmp != nil)
			return 0
...
func cvec_pop_glBuffer(vec *cvector_glBuffer) glBuffer {
	return *(*glBuffer)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glBuffer{})*uintptr(func() uint64 {
		p := &vec.Size
		*p--
		return *p
	}())))
...
func cvec_back_glBuffer(vec *cvector_glBuffer) *glBuffer {
	return (*glBuffer)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glBuffer{})*uintptr(vec.Size-1)))
}
...
func cvec_insert_glBuffer(vec *cvector_glBuffer, i uint64, a glBuffer) int64 {
	...
	if vec.Capacity > vec.Size {
		libc.MemMove(unsafe.Pointer((*glBuffer)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glBuffer{})*uintptr(i+1)))), unsafe.Pointer((*glBuffer)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glBuffer{})*uintptr(i)))), int((vec.Size-i)*uint64(unsafe.Sizeof(glBuffer{}))))
		*(*glBuffer)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glBuffer{})*uintptr(i))) = a
	} else {
		tmp_sz = (vec.Capacity + 1) * 2
		if (func() *glBuffer {
			tmp = (*glBuffer)(libc.Realloc(unsafe.Pointer(vec.A), int(tmp_sz*uint64(unsafe.Sizeof(glBuffer{})))))
...
func cvec_insert_array_glBuffer(vec *cvector_glBuffer, i uint64, a *glBuffer, num uint64) int64 {
	...
	libc.MemMove(unsafe.Pointer((*glBuffer)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glBuffer{})*uintptr(i+num)))), unsafe.Pointer((*glBuffer)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glBuffer{})*uintptr(i)))), int((vec.Size-i)*uint64(unsafe.Sizeof(glBuffer{}))))
	libc.MemMove(unsafe.Pointer((*glBuffer)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glBuffer{})*uintptr(i)))), unsafe.Pointer(a), int(num*uint64(unsafe.Sizeof(glBuffer{}))))
	vec.Size += num
	return 1
}
func cvec_replace_glBuffer(vec *cvector_glBuffer, i uint64, a glBuffer) glBuffer {
	var tmp glBuffer = *(*glBuffer)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glBuffer{})*uintptr(i)))
	*(*glBuffer)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glBuffer{})*uintptr(i))) = a
	return tmp
}
func cvec_erase_glBuffer(vec *cvector_glBuffer, start uint64, end uint64) {
	var d uint64 = end - start + 1
	libc.MemMove(unsafe.Pointer((*glBuffer)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glBuffer{})*uintptr(start)))), unsafe.Pointer((*glBuffer)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glBuffer{})*uintptr(end+1)))), int((vec.Size-1-end)*uint64(unsafe.Sizeof(glBuffer{}))))
	vec.Size -= d
}
func cvec_reserve_glBuffer(vec *cvector_glBuffer, size uint64) int64 {
	...
	if vec.Capacity < size {
		if (func() *glBuffer {
			tmp = (*glBuffer)(libc.Realloc(unsafe.Pointer(vec.A), int((size+CVEC_glBuffer_SZ)*uint64(unsafe.Sizeof(glBuffer{})))))
			return tmp
		}()) == nil {
			libc.Assert(tmp != nil)
			return 0
...
func cvec_set_cap_glBuffer(vec *cvector_glBuffer, size uint64) int64 {
	...
	if (func() *glBuffer {
		tmp = (*glBuffer)(libc.Realloc(unsafe.Pointer(vec.A), int(size*uint64(unsafe.Sizeof(glBuffer{})))))
		return tmp
	}()) == nil {
		libc.Assert(tmp != nil)
		return 0
...
func cvec_set_val_sz_glBuffer(vec *cvector_glBuffer, val glBuffer) {
	var i uint64
	for i = 0; i < vec.Size; i++ {
		*(*glBuffer)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glBuffer{})*uintptr(i))) = val
	}
}
...
func cvec_glProgram_heap(size uint64, capacity uint64) *cvector_glProgram {
	...
	if (func() *glProgram {
		p := &vec.A
		vec.A = (*glProgram)(libc.Malloc(int(vec.Capacity * uint64(unsafe.Sizeof(glProgram{})))))
		return *p
	}()) == nil {
		libc.Assert(vec.A != nil)
		libc.Free(unsafe.Pointer(vec))
...
func cvec_init_glProgram_heap(vals *glProgram, num uint64) *cvector_glProgram {
	...
	libc.MemMove(unsafe.Pointer(vec.A), unsafe.Pointer(vals), int(num*uint64(unsafe.Sizeof(glProgram{}))))
	return vec
}
...
func cvec_copy_glProgram(dest *cvector_glProgram, src *cvector_glProgram) int64 {
	...
	if (func() *glProgram {
		tmp = (*glProgram)(libc.Realloc(unsafe.Pointer(dest.A), int(src.Capacity*uint64(unsafe.Sizeof(glProgram{})))))
		return tmp
	}()) == nil {
		libc.Assert(tmp != nil)
		return 0
	...
	dest.A = tmp
	libc.MemMove(unsafe.Pointer(dest.A), unsafe.Pointer(src.A), int(src.Size*uint64(unsafe.Sizeof(glProgram{}))))
	dest.Size = src.Size
	dest.Capacity = src.Capacity
	return 1
}
func cvec_push_glProgram(vec *cvector_glProgram, a glProgram) int64 {
	...
	if vec.Capacity > vec.Size {
		*(*glProgram)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glProgram{})*uintptr(func() uint64 {
			p := &vec.Size
			x := *p
			*p++
			return x
		...
		tmp_sz = (vec.Capacity + 1) * 2
		if (func() *glProgram {
			tmp = (*glProgram)(libc.Realloc(unsafe.Pointer(vec.A), int(tmp_sz*uint64(unsafe.Sizeof(glProgram{})))))
			return tmp
		}()) == nil {
			libc.Assert(tmp != nil)
			return 0
...
func cvec_pop_glProgram(vec *cvector_glProgram) glProgram {
	return *(*glProgram)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glProgram{})*uintptr(func() uint64 {
		p := &vec.Size
		*p--
		return *p
	}())))
...
func cvec_back_glProgram(vec *cvector_glProgram) *glProgram {
	return (*glProgram)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glProgram{})*uintptr(vec.Size-1)))
}
...
func cvec_insert_glProgram(vec *cvector_glProgram, i uint64, a glProgram) int64 {
	...
	if vec.Capacity > vec.Size {
		libc.MemMove(unsafe.Pointer((*glProgram)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glProgram{})*uintptr(i+1)))), unsafe.Pointer((*glProgram)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glProgram{})*uintptr(i)))), int((vec.Size-i)*uint64(unsafe.Sizeof(glProgram{}))))
		*(*glProgram)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glProgram{})*uintptr(i))) = a
	} else {
		tmp_sz = (vec.Capacity + 1) * 2
		if (func() *glProgram {
			tmp = (*glProgram)(libc.Realloc(unsafe.Pointer(vec.A), int(tmp_sz*uint64(unsafe.Sizeof(glProgram{})))))
...
func cvec_insert_array_glProgram(vec *cvector_glProgram, i uint64, a *glProgram, num uint64) int64 {
	...
	libc.MemMove(unsafe.Pointer((*glProgram)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glProgram{})*uintptr(i+num)))), unsafe.Pointer((*glProgram)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glProgram{})*uintptr(i)))), int((vec.Size-i)*uint64(unsafe.Sizeof(glProgram{}))))
	libc.MemMove(unsafe.Pointer((*glProgram)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glProgram{})*uintptr(i)))), unsafe.Pointer(a), int(num*uint64(unsafe.Sizeof(glProgram{}))))
	vec.Size += num
	return 1
}
func cvec_replace_glProgram(vec *cvector_glProgram, i uint64, a glProgram) glProgram {
	var tmp glProgram = *(*glProgram)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glProgram{})*uintptr(i)))
	*(*glProgram)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glProgram{})*uintptr(i))) = a
	return tmp
}
func cvec_erase_glProgram(vec *cvector_glProgram, start uint64, end uint64) {
	var d uint64 = end - start + 1
	libc.MemMove(unsafe.Pointer((*glProgram)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glProgram{})*uintptr(start)))), unsafe.Pointer((*glProgram)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glProgram{})*uintptr(end+1)))), int((vec.Size-1-end)*uint64(unsafe.Sizeof(glProgram{}))))
	vec.Size -= d
}
func cvec_reserve_glProgram(vec *cvector_glProgram, size uint64) int64 {
	...
	if vec.Capacity < size {
		if (func() *glProgram {
			tmp = (*glProgram)(libc.Realloc(unsafe.Pointer(vec.A), int((size+CVEC_glProgram_SZ)*uint64(unsafe.Sizeof(glProgram{})))))
			return tmp
		}()) == nil {
			libc.Assert(tmp != nil)
			return 0
...
func cvec_set_cap_glProgram(vec *cvector_glProgram, size uint64) int64 {
	...
	if (func() *glProgram {
		tmp = (*glProgram)(libc.Realloc(unsafe.Pointer(vec.A), int(size*uint64(unsafe.Sizeof(glProgram{})))))
		return tmp
	}()) == nil {
		libc.Assert(tmp != nil)
		return 0
...
func cvec_set_val_sz_glProgram(vec *cvector_glProgram, val glProgram) {
	var i uint64
	for i = 0; i < vec.Size; i++ {
		*(*glProgram)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glProgram{})*uintptr(i))) = val
	}
}
...
func cvec_glVertex_heap(size uint64, capacity uint64) *cvector_glVertex {
	...
	if (func() *glVertex {
		p := &vec.A
		vec.A = (*glVertex)(libc.Malloc(int(vec.Capacity * uint64(unsafe.Sizeof(glVertex{})))))
		return *p
	}()) == nil {
		libc.Assert(vec.A != nil)
		libc.Free(unsafe.Pointer(vec))
...
func cvec_init_glVertex_heap(vals *glVertex, num uint64) *cvector_glVertex {
	...
	libc.MemMove(unsafe.Pointer(vec.A), unsafe.Pointer(vals), int(num*uint64(unsafe.Sizeof(glVertex{}))))
	return vec
}
...
func cvec_copy_glVertex(dest *cvector_glVertex, src *cvector_glVertex) int64 {
	...
	if (func() *glVertex {
		tmp = (*glVertex)(libc.Realloc(unsafe.Pointer(dest.A), int(src.Capacity*uint64(unsafe.Sizeof(glVertex{})))))
		return tmp
	}()) == nil {
		libc.Assert(tmp != nil)
		return 0
	...
	dest.A = tmp
	libc.MemMove(unsafe.Pointer(dest.A), unsafe.Pointer(src.A), int(src.Size*uint64(unsafe.Sizeof(glVertex{}))))
	dest.Size = src.Size
	dest.Capacity = src.Capacity
	return 1
}
func cvec_push_glVertex(vec *cvector_glVertex, a glVertex) int64 {
	...
	if vec.Capacity > vec.Size {
		*(*glVertex)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glVertex{})*uintptr(func() uint64 {
			p := &vec.Size
			x := *p
			*p++
			return x
		...
		tmp_sz = (vec.Capacity + 1) * 2
		if (func() *glVertex {
			tmp = (*glVertex)(libc.Realloc(unsafe.Pointer(vec.A), int(tmp_sz*uint64(unsafe.Sizeof(glVertex{})))))
			return tmp
		}()) == nil {
			libc.Assert(tmp != nil)
			return 0
...
func cvec_pop_glVertex(vec *cvector_glVertex) glVertex {
	return *(*glVertex)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glVertex{})*uintptr(func() uint64 {
		p := &vec.Size
		*p--
		return *p
	}())))
...
func cvec_back_glVertex(vec *cvector_glVertex) *glVertex {
	return (*glVertex)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glVertex{})*uintptr(vec.Size-1)))
}
...
func cvec_insert_glVertex(vec *cvector_glVertex, i uint64, a glVertex) int64 {
	...
	if vec.Capacity > vec.Size {
		libc.MemMove(unsafe.Pointer((*glVertex)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glVertex{})*uintptr(i+1)))), unsafe.Pointer((*glVertex)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glVertex{})*uintptr(i)))), int((vec.Size-i)*uint64(unsafe.Sizeof(glVertex{}))))
		*(*glVertex)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glVertex{})*uintptr(i))) = a
	} else {
		tmp_sz = (vec.Capacity + 1) * 2
		if (func() *glVertex {
			tmp = (*glVertex)(libc.Realloc(unsafe.Pointer(vec.A), int(tmp_sz*uint64(unsafe.Sizeof(glVertex{})))))
...
func cvec_insert_array_glVertex(vec *cvector_glVertex, i uint64, a *glVertex, num uint64) int64 {
	...
	libc.MemMove(unsafe.Pointer((*glVertex)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glVertex{})*uintptr(i+num)))), unsafe.Pointer((*glVertex)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glVertex{})*uintptr(i)))), int((vec.Size-i)*uint64(unsafe.Sizeof(glVertex{}))))
	libc.MemMove(unsafe.Pointer((*glVertex)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glVertex{})*uintptr(i)))), unsafe.Pointer(a), int(num*uint64(unsafe.Sizeof(glVertex{}))))
	vec.Size += num
	return 1
}
func cvec_replace_glVertex(vec *cvector_glVertex, i uint64, a glVertex) glVertex {
	var tmp glVertex = *(*glVertex)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glVertex{})*uintptr(i)))
	*(*glVertex)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glVertex{})*uintptr(i))) = a
	return tmp
}
func cvec_erase_glVertex(vec *cvector_glVertex, start uint64, end uint64) {
	var d uint64 = end - start + 1
	libc.MemMove(unsafe.Pointer((*glVertex)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glVertex{})*uintptr(start)))), unsafe.Pointer((*glVertex)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glVertex{})*uintptr(end+1)))), int((vec.Size-1-end)*uint64(unsafe.Sizeof(glVertex{}))))
	vec.Size -= d
}
func cvec_reserve_glVertex(vec *cvector_glVertex, size uint64) int64 {
	...
	if vec.Capacity < size {
		if (func() *glVertex {
			tmp = (*glVertex)(libc.Realloc(unsafe.Pointer(vec.A), int((size+CVEC_glVertex_SZ)*uint64(unsafe.Sizeof(glVertex{})))))
			return tmp
		}()) == nil {
			libc.Assert(tmp != nil)
			return 0
...
func cvec_set_cap_glVertex(vec *cvector_glVertex, size uint64) int64 {
	...
	if (func() *glVertex {
		tmp = (*glVertex)(libc.Realloc(unsafe.Pointer(vec.A), int(size*uint64(unsafe.Sizeof(glVertex{})))))
		return tmp
	}()) == nil {
		libc.Assert(tmp != nil)
		return 0
...
func cvec_set_val_sz_glVertex(vec *cvector_glVertex, val glVertex) {
	var i uint64
	for i = 0; i < vec.Size; i++ {
		*(*glVertex)(unsafe.Add(unsafe.Pointer(vec.A), unsafe.Sizeof(glVertex{})*uintptr(i))) = val
	}
}
...
func cvec_reserve_float(vec *cvector_float, size uint64) int64 {
	...
	if vec.Capacity < size {
		if (func() *float32 {
			tmp = (*float32)(libc.Realloc(unsafe.Pointer(vec.A), int((size+CVEC_float_SZ)*uint64(unsafe.Sizeof(float32(0))))))
			return tmp
		}()) == nil {
			libc.Assert(tmp != nil)
			return 0
...
func do_vertex(v *glVertex_Attrib, enabled *int64, num_enabled uint64, i uint64, vert uint64) {
	...
	for j := int64(0); uint64(j) < num_enabled; j++ {
		...
		buf_pos = (*u8)(unsafe.Add(unsafe.Pointer((*u8)(unsafe.Add(unsafe.Pointer((*(*glBuffer)(unsafe.Add(unsafe.Pointer(c.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr(buf)))).Data), (*(*glVertex_Attrib)(unsafe.Add(unsafe.Pointer(v), unsafe.Sizeof(glVertex_Attrib{})*uintptr(*(*int64)(unsafe.Add(unsafe.Pointer(enabled), unsafe.Sizeof(int64(0))*uintptr(j))))))).Offset))), uint64((*(*glVertex_Attrib)(unsafe.Add(unsafe.Pointer(v), unsafe.Sizeof(glVertex_Attrib{})*uintptr(*(*int64)(unsafe.Add(unsafe.Pointer(enabled), unsafe.Sizeof(int64(0))*uintptr(j))))))).Stride)*i))
		for {
			tmpvec4.X = 0.0
			tmpvec4.Y = 0.0
			tmpvec4.Z = 0.0
		...
		libc.MemCpy(unsafe.Pointer(&tmpvec4), unsafe.Pointer(buf_pos), int(uintptr((*(*glVertex_Attrib)(unsafe.Add(unsafe.Pointer(v), unsafe.Sizeof(glVertex_Attrib{})*uintptr(*(*int64)(unsafe.Add(unsafe.Pointer(enabled), unsafe.Sizeof(int64(0))*uintptr(j))))))).Size)*unsafe.Sizeof(float32(0))))
		c.Vertex_attribs_vs[*(*int64)(unsafe.Add(unsafe.Pointer(enabled), unsafe.Sizeof(int64(0))*uintptr(j)))] = tmpvec4
	}
	...
	(*(*glProgram)(unsafe.Add(unsafe.Pointer(c.Programs.A), unsafe.Sizeof(glProgram{})*uintptr(c.Cur_program)))).Vertex_shader(vs_out, unsafe.Pointer(&c.Vertex_attribs_vs[0]), &c.Builtins, (*(*glProgram)(unsafe.Add(unsafe.Pointer(c.Programs.A), unsafe.Sizeof(glProgram{})*uintptr(c.Cur_program)))).Uniform)
	(*(*glVertex)(unsafe.Add(unsafe.Pointer(c.Glverts.A), unsafe.Sizeof(glVertex{})*uintptr(vert)))).Vs_out = vs_out
	(*(*glVertex)(unsafe.Add(unsafe.Pointer(c.Glverts.A), unsafe.Sizeof(glVertex{})*uintptr(vert)))).Clip_space = c.Builtins.Gl_Position
	(*(*glVertex)(unsafe.Add(unsafe.Pointer(c.Glverts.A), unsafe.Sizeof(glVertex{})*uintptr(vert)))).Edge_flag = 1
	(*(*glVertex)(unsafe.Add(unsafe.Pointer(c.Glverts.A), unsafe.Sizeof(glVertex{})*uintptr(vert)))).Clip_code = gl_clipcode(c.Builtins.Gl_Position)
}
func vertex_stage(first GLint, count GLsizei, instance_id GLsizei, base_instance GLuint, use_elements GLboolean) {
	...
	var v *glVertex_Attrib = &(*(*glVertex_Array)(unsafe.Add(unsafe.Pointer(c.Vertex_arrays.A), unsafe.Sizeof(glVertex_Array{})*uintptr(c.Cur_vertex_array)))).Vertex_attribs[0]
	var elem_buffer GLuint = (*(*glVertex_Array)(unsafe.Add(unsafe.Pointer(c.Vertex_arrays.A), unsafe.Sizeof(glVertex_Array{})*uintptr(c.Cur_vertex_array)))).Element_buffer
	for func() uint64 {
		i = 0
		return func() uint64 {
			j = 0
		...
		if (*(*glVertex_Attrib)(unsafe.Add(unsafe.Pointer(v), unsafe.Sizeof(glVertex_Attrib{})*uintptr(i)))).Enabled != 0 {
			if (*(*glVertex_Attrib)(unsafe.Add(unsafe.Pointer(v), unsafe.Sizeof(glVertex_Attrib{})*uintptr(i)))).Divisor == 0 {
			...
			} else if (instance_id % GLsizei((*(*glVertex_Attrib)(unsafe.Add(unsafe.Pointer(v), unsafe.Sizeof(glVertex_Attrib{})*uintptr(i)))).Divisor)) == 0 {
				var n int64 = int64(instance_id/GLsizei((*(*glVertex_Attrib)(unsafe.Add(unsafe.Pointer(v), unsafe.Sizeof(glVertex_Attrib{})*uintptr(i)))).Divisor) + GLsizei(base_instance))
				buf_pos = (*u8)(unsafe.Add(unsafe.Pointer((*u8)(unsafe.Add(unsafe.Pointer((*(*glBuffer)(unsafe.Add(unsafe.Pointer(c.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr((*(*glVertex_Attrib)(unsafe.Add(unsafe.Pointer(v), unsafe.Sizeof(glVertex_Attrib{})*uintptr(i)))).Buf)))).Data), (*(*glVertex_Attrib)(unsafe.Add(unsafe.Pointer(v), unsafe.Sizeof(glVertex_Attrib{})*uintptr(i)))).Offset))), int64((*(*glVertex_Attrib)(unsafe.Add(unsafe.Pointer(v), unsafe.Sizeof(glVertex_Attrib{})*uintptr(i)))).Stride)*n))
				for {
					tmpvec4.X = 0.0
					tmpvec4.Y = 0.0
					tmpvec4.Z = 0.0
				...
				libc.MemCpy(unsafe.Pointer(&tmpvec4), unsafe.Pointer(buf_pos), int(uintptr((*(*glVertex_Attrib)(unsafe.Add(unsafe.Pointer(v), unsafe.Sizeof(glVertex_Attrib{})*uintptr(enabled[j])))).Size)*unsafe.Sizeof(float32(0))))
	...
	if use_elements == 0 {
		for func() uint64 {
		...
		}(); i < uint64(first+GLint(count)); func() uint64 {
			i++
			return func() uint64 {
				p := &vert
				*p++
			...
			do_vertex(v, &enabled[0], num_enabled, i, vert)
		}
	} else {
		var (
			uint_array   *GLuint   = (*GLuint)(unsafe.Pointer((*(*glBuffer)(unsafe.Add(unsafe.Pointer(c.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr(elem_buffer)))).Data))
			ushort_array *GLushort = (*GLushort)(unsafe.Pointer((*(*glBuffer)(unsafe.Add(unsafe.Pointer(c.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr(elem_buffer)))).Data))
			ubyte_array  *GLubyte  = (*GLubyte)(unsafe.Pointer((*(*glBuffer)(unsafe.Add(unsafe.Pointer(c.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr(elem_buffer)))).Data))
		)
		if (*(*glBuffer)(unsafe.Add(unsafe.Pointer(c.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr(elem_buffer)))).Type == GLenum(GL_UNSIGNED_BYTE) {
			for func() uint64 {
				vert = 0
				return func() uint64 {
					i = uint64(first)
				...
				do_vertex(v, &enabled[0], num_enabled, uint64(*(*GLubyte)(unsafe.Add(unsafe.Pointer(ubyte_array), i))), vert)
			}
		} else if (*(*glBuffer)(unsafe.Add(unsafe.Pointer(c.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr(elem_buffer)))).Type == GLenum(GL_UNSIGNED_SHORT) {
			for func() uint64 {
				vert = 0
				return func() uint64 {
					i = uint64(first)
				...
				do_vertex(v, &enabled[0], num_enabled, uint64(*(*GLushort)(unsafe.Add(unsafe.Pointer(ushort_array), unsafe.Sizeof(GLushort(0))*uintptr(i)))), vert)
			}
		} else {
			for func() uint64 {
				vert = 0
				...
				do_vertex(v, &enabled[0], num_enabled, uint64(*(*GLuint)(unsafe.Add(unsafe.Pointer(uint_array), unsafe.Sizeof(GLuint(0))*uintptr(i)))), vert)
			}
		}
	}
}
func draw_point(vert *glVertex) {
	...
	for i := float32(y - p_size/2); i < y+p_size/2; i++ {
		...
		for j := float32(x - p_size/2); j < x+p_size/2; j++ {
			...
			(*(*glProgram)(unsafe.Add(unsafe.Pointer(c.Programs.A), unsafe.Sizeof(glProgram{})*uintptr(c.Cur_program)))).Fragment_shader(&fs_input[0], &c.Builtins, (*(*glProgram)(unsafe.Add(unsafe.Pointer(c.Programs.A), unsafe.Sizeof(glProgram{})*uintptr(c.Cur_program)))).Uniform)
...
func run_pipeline(mode GLenum, first GLint, count GLsizei, instance GLsizei, base_instance GLuint, use_elements GLboolean) {
	...
	if mode == GLenum(GL_POINTS) {
		...
		for func() uint64 {
		...
		}(); i < uint64(first+GLint(count)-1); func() uint64 {
			i += 2
			return func() uint64 {
				vert += 2
				return vert
			...
			draw_line_clip((*glVertex)(unsafe.Add(unsafe.Pointer(c.Glverts.A), unsafe.Sizeof(glVertex{})*uintptr(vert))), (*glVertex)(unsafe.Add(unsafe.Pointer(c.Glverts.A), unsafe.Sizeof(glVertex{})*uintptr(vert+1))))
		}
		...
		draw_line_clip((*glVertex)(unsafe.Add(unsafe.Pointer(c.Glverts.A), unsafe.Sizeof(glVertex{})*uintptr(count-1))), (*glVertex)(unsafe.Add(unsafe.Pointer(c.Glverts.A), unsafe.Sizeof(glVertex{})*0)))
		...
		for func() uint64 {
		...
		}(); i < uint64(first+GLint(count)-2); func() uint64 {
			i += 3
			return func() uint64 {
				vert += 3
				return vert
			...
			draw_triangle((*glVertex)(unsafe.Add(unsafe.Pointer(c.Glverts.A), unsafe.Sizeof(glVertex{})*uintptr(vert))), (*glVertex)(unsafe.Add(unsafe.Pointer(c.Glverts.A), unsafe.Sizeof(glVertex{})*uintptr(vert+1))), (*glVertex)(unsafe.Add(unsafe.Pointer(c.Glverts.A), unsafe.Sizeof(glVertex{})*uintptr(vert+2))), vert+uint64(provoke))
		}
		...
		for vert = 2; vert < uint64(count); vert++ {
			draw_triangle((*glVertex)(unsafe.Add(unsafe.Pointer(c.Glverts.A), unsafe.Sizeof(glVertex{})*uintptr(a))), (*glVertex)(unsafe.Add(unsafe.Pointer(c.Glverts.A), unsafe.Sizeof(glVertex{})*uintptr(b))), (*glVertex)(unsafe.Add(unsafe.Pointer(c.Glverts.A), unsafe.Sizeof(glVertex{})*uintptr(vert))), vert+uint64(provoke))
			if toggle == 0 {
				a = vert
			} else {
				b = vert
		...
		for vert = 2; vert < uint64(count); vert++ {
			draw_triangle((*glVertex)(unsafe.Add(unsafe.Pointer(c.Glverts.A), unsafe.Sizeof(glVertex{})*0)), (*glVertex)(unsafe.Add(unsafe.Pointer(c.Glverts.A), unsafe.Sizeof(glVertex{})*uintptr(vert-1))), (*glVertex)(unsafe.Add(unsafe.Pointer(c.Glverts.A), unsafe.Sizeof(glVertex{})*uintptr(vert))), vert+uint64(provoke))
		}
	}
}
...
func setup_fs_input(t float32, v1_out *float32, v2_out *float32, wa float32, wb float32, provoke uint64) {
	...
	for i := int64(0); i < c.Vs_output.Size; i++ {
		if *(*GLenum)(unsafe.Add(unsafe.Pointer(c.Vs_output.Interpolation), unsafe.Sizeof(GLenum(0))*uintptr(i))) == GLenum(SMOOTH) {
		...
		} else if *(*GLenum)(unsafe.Add(unsafe.Pointer(c.Vs_output.Interpolation), unsafe.Sizeof(GLenum(0))*uintptr(i))) == GLenum(NOPERSPECTIVE) {
...
func draw_line_clip(v1 *glVertex, v2 *glVertex) {
	...
	var provoke uint64
	if c.Provoking_vert == GLenum(GL_LAST_VERTEX_CONVENTION) {
		provoke = uint64((int64(uintptr(unsafe.Pointer(v2)) - uintptr(unsafe.Pointer(c.Glverts.A)))) / int64(unsafe.Sizeof(glVertex{})))
	} else {
		provoke = uint64((int64(uintptr(unsafe.Pointer(v1)) - uintptr(unsafe.Pointer(c.Glverts.A)))) / int64(unsafe.Sizeof(glVertex{})))
	}
	if cc1&cc2 != 0 {
		return
	} else if (cc1 | cc2) == 0 {
...
func draw_triangle_point(v0 *glVertex, v1 *glVertex, v2 *glVertex, provoke uint64) {
	...
	for i := int64(0); i < 3; i++ {
		...
		for j := int64(0); j < c.Vs_output.Size; j++ {
			if *(*GLenum)(unsafe.Add(unsafe.Pointer(c.Vs_output.Interpolation), unsafe.Sizeof(GLenum(0))*uintptr(j))) != GLenum(FLAT) {
...
func Init_glContext(context *GlContext, back **U32, w int64, h int64, bitdepth int64, Rmask U32, Gmask U32, Bmask U32, Amask U32) int64 {
	...
	context.Draw_triangle_front = func(v0 *glVertex, v1 *glVertex, v2 *glVertex, provoke uint64) {
		func(v0 *glVertex, v1 *glVertex, v2 *glVertex, provoke uint64) {
			draw_triangle_fill(v0, v1, v2, provoke)
		}(v0, v1, v2, provoke)
	}
	context.Draw_triangle_back = func(v0 *glVertex, v1 *glVertex, v2 *glVertex, provoke uint64) {
		func(v0 *glVertex, v1 *glVertex, v2 *glVertex, provoke uint64) {
			draw_triangle_fill(v0, v1, v2, provoke)
		}(v0, v1, v2, provoke)
	}
...
func Free_glContext(context *GlContext) {
	...
	for i = 0; uint64(i) < context.Buffers.Size; i++ {
		if (*(*glBuffer)(unsafe.Add(unsafe.Pointer(context.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr(i)))).User_owned == 0 {
			stdio.Printf("freeing buffer %d\n", i)
			libc.Free(unsafe.Pointer((*(*glBuffer)(unsafe.Add(unsafe.Pointer(context.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr(i)))).Data))
		}
	}
...
func glGetString(name GLenum) *GLubyte {
	var (
		vendor [15]GLubyte = func() [15]GLubyte {
			var t [15]GLubyte
			copy(t[:], ([]GLubyte)("Robert Winkler"))
			return t
		}()
		renderer [11]GLubyte = func() [11]GLubyte {
			var t [11]GLubyte
			copy(t[:], ([]GLubyte)("PortableGL"))
			return t
		}()
		version [31]GLubyte = func() [31]GLubyte {
			var t [31]GLubyte
			copy(t[:], ([]GLubyte)("OpenGL 3.x-ish PortableGL 0.94"))
			return t
		}()
		shading_language [6]GLubyte = func() [6]GLubyte {
			var t [6]GLubyte
			copy(t[:], ([]GLubyte)("C/C++"))
			return t
		}()
...
func glGenVertexArrays(n GLsizei, arrays *GLuint) {
	...
	for i := int64(1); uint64(i) < c.Vertex_arrays.Size && n >= 0; i++ {
		if (*(*glVertex_Array)(unsafe.Add(unsafe.Pointer(c.Vertex_arrays.A), unsafe.Sizeof(glVertex_Array{})*uintptr(i)))).Deleted != 0 {
			*(*glVertex_Array)(unsafe.Add(unsafe.Pointer(c.Vertex_arrays.A), unsafe.Sizeof(glVertex_Array{})*uintptr(i))) = tmp
			*(*GLuint)(unsafe.Add(unsafe.Pointer(arrays), unsafe.Sizeof(GLuint(0))*uintptr(func() GLsizei {
				p := &n
				x := *p
				*p--
				return x
	...
	for ; n >= 0; n-- {
		...
		*(*GLuint)(unsafe.Add(unsafe.Pointer(arrays), unsafe.Sizeof(GLuint(0))*uintptr(n))) = GLuint(c.Vertex_arrays.Size - 1)
	}
}
func glDeleteVertexArrays(n GLsizei, arrays *GLuint) {
	for i := int64(0); i < int64(n); i++ {
		...
		if *(*GLuint)(unsafe.Add(unsafe.Pointer(arrays), unsafe.Sizeof(GLuint(0))*uintptr(i))) == c.Cur_vertex_array {
			libc.MemCpy(unsafe.Pointer((*glVertex_Array)(unsafe.Add(unsafe.Pointer(c.Vertex_arrays.A), unsafe.Sizeof(glVertex_Array{})*0))), unsafe.Pointer((*glVertex_Array)(unsafe.Add(unsafe.Pointer(c.Vertex_arrays.A), unsafe.Sizeof(glVertex_Array{})*uintptr(*(*GLuint)(unsafe.Add(unsafe.Pointer(arrays), unsafe.Sizeof(GLuint(0))*uintptr(i))))))), int(unsafe.Sizeof(glVertex_Array{})))
...
func GlGenBuffers(n GLsizei, buffers *GLuint) {
	...
	for i := int64(1); uint64(i) < c.Buffers.Size && n >= 0; i++ {
		if (*(*glBuffer)(unsafe.Add(unsafe.Pointer(c.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr(i)))).Deleted != 0 {
			*(*glBuffer)(unsafe.Add(unsafe.Pointer(c.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr(i))) = tmp
			*(*GLuint)(unsafe.Add(unsafe.Pointer(buffers), unsafe.Sizeof(GLuint(0))*uintptr(func() GLsizei {
				p := &n
				x := *p
				*p--
				return x
	...
	for ; n >= 0; n-- {
		...
		*(*GLuint)(unsafe.Add(unsafe.Pointer(buffers), unsafe.Sizeof(GLuint(0))*uintptr(n))) = GLuint(c.Buffers.Size - 1)
	}
}
func glDeleteBuffers(n GLsizei, buffers *GLuint) {
	...
	for i := int64(0); i < int64(n); i++ {
		...
		type_ = (*(*glBuffer)(unsafe.Add(unsafe.Pointer(c.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr(*(*GLuint)(unsafe.Add(unsafe.Pointer(buffers), unsafe.Sizeof(GLuint(0))*uintptr(i))))))).Type
		...
		if (*(*glBuffer)(unsafe.Add(unsafe.Pointer(c.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr(*(*GLuint)(unsafe.Add(unsafe.Pointer(buffers), unsafe.Sizeof(GLuint(0))*uintptr(i))))))).User_owned == 0 {
			libc.Free(unsafe.Pointer((*(*glBuffer)(unsafe.Add(unsafe.Pointer(c.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr(*(*GLuint)(unsafe.Add(unsafe.Pointer(buffers), unsafe.Sizeof(GLuint(0))*uintptr(i))))))).Data))
			(*(*glBuffer)(unsafe.Add(unsafe.Pointer(c.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr(*(*GLuint)(unsafe.Add(unsafe.Pointer(buffers), unsafe.Sizeof(GLuint(0))*uintptr(i))))))).Data = nil
		}
		(*(*glBuffer)(unsafe.Add(unsafe.Pointer(c.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr(*(*GLuint)(unsafe.Add(unsafe.Pointer(buffers), unsafe.Sizeof(GLuint(0))*uintptr(i))))))).Deleted = GL_TRUE
	}
}
...
func GlBindBuffer(target GLenum, buffer GLuint) {
	...
	if uint64(buffer) < c.Buffers.Size && (*(*glBuffer)(unsafe.Add(unsafe.Pointer(c.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr(buffer)))).Deleted == GL_FALSE {
		c.Bound_buffers[target] = buffer
		(*(*glBuffer)(unsafe.Add(unsafe.Pointer(c.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr(buffer)))).Type = target
	} else if c.Error == 0 {
		c.Error = GLenum(GL_INVALID_OPERATION)
	}
}
func GlBufferData(target GLenum, size GLsizei, data unsafe.Pointer, usage GLenum) {
	...
	libc.Free(unsafe.Pointer((*(*glBuffer)(unsafe.Add(unsafe.Pointer(c.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr(c.Bound_buffers[target])))).Data))
	if (func() *u8 {
		p := &(*(*glBuffer)(unsafe.Add(unsafe.Pointer(c.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr(c.Bound_buffers[target])))).Data
		(*(*glBuffer)(unsafe.Add(unsafe.Pointer(c.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr(c.Bound_buffers[target])))).Data = (*u8)(libc.Malloc(int(size)))
		return *p
	}()) == nil {
		if c.Error == 0 {
			c.Error = GLenum(GL_OUT_OF_MEMORY)
	...
	if data != nil {
		libc.MemCpy(unsafe.Pointer((*(*glBuffer)(unsafe.Add(unsafe.Pointer(c.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr(c.Bound_buffers[target])))).Data), data, int(size))
	}
	(*(*glBuffer)(unsafe.Add(unsafe.Pointer(c.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr(c.Bound_buffers[target])))).User_owned = GL_FALSE
	(*(*glBuffer)(unsafe.Add(unsafe.Pointer(c.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr(c.Bound_buffers[target])))).Size = size
	if target == GLenum(GL_ELEMENT_ARRAY_BUFFER-GL_ARRAY_BUFFER) {
		(*(*glVertex_Array)(unsafe.Add(unsafe.Pointer(c.Vertex_arrays.A), unsafe.Sizeof(glVertex_Array{})*uintptr(c.Cur_vertex_array)))).Element_buffer = c.Bound_buffers[target]
	}
}
func glBufferSubData(target GLenum, offset GLsizei, size GLsizei, data unsafe.Pointer) {
	...
	if offset+size > (*(*glBuffer)(unsafe.Add(unsafe.Pointer(c.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr(c.Bound_buffers[target])))).Size {
		if c.Error == 0 {
			c.Error = GLenum(GL_INVALID_VALUE)
		}
		return
	}
	libc.MemCpy(unsafe.Add(unsafe.Pointer((*(*glBuffer)(unsafe.Add(unsafe.Pointer(c.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr(c.Bound_buffers[target])))).Data), offset), data, int(size))
}
...
func GlVertexAttribPointer(index GLuint, size GLint, type_ GLenum, normalized GLboolean, stride GLsizei, offset GLsizei) {
	...
	var v *glVertex_Attrib = &((*(*glVertex_Array)(unsafe.Add(unsafe.Pointer(c.Vertex_arrays.A), unsafe.Sizeof(glVertex_Array{})*uintptr(c.Cur_vertex_array)))).Vertex_attribs[index])
	v.Size = size
	v.Type = type_
	if stride != 0 {
		v.Stride = stride
...
func glDrawElements(mode GLenum, count GLsizei, type_ GLenum, offset GLsizei) {
	...
	(*(*glBuffer)(unsafe.Add(unsafe.Pointer(c.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr((*(*glVertex_Array)(unsafe.Add(unsafe.Pointer(c.Vertex_arrays.A), unsafe.Sizeof(glVertex_Array{})*uintptr(c.Cur_vertex_array)))).Element_buffer)))).Type = type_
...
func glPolygonMode(face GLenum, mode GLenum) {
	...
	if mode == GLenum(GL_POINT) {
		if face == GLenum(GL_FRONT) {
			...
			c.Draw_triangle_front = func(v0 *glVertex, v1 *glVertex, v2 *glVertex, provoke uint64) {
				func(v0 *glVertex, v1 *glVertex, v2 *glVertex, provoke uint64) {
					draw_triangle_point(v0, v1, v2, provoke)
				}(v0, v1, v2, provoke)
			}
		} else if face == GLenum(GL_BACK) {
			c.Poly_mode_back = mode
			c.Draw_triangle_back = func(v0 *glVertex, v1 *glVertex, v2 *glVertex, provoke uint64) {
				func(v0 *glVertex, v1 *glVertex, v2 *glVertex, provoke uint64) {
					draw_triangle_point(v0, v1, v2, provoke)
				}(v0, v1, v2, provoke)
			}
		...
		if face == GLenum(GL_FRONT) {
			...
			c.Draw_triangle_front = func(v0 *glVertex, v1 *glVertex, v2 *glVertex, provoke uint64) {
				func(v0 *glVertex, v1 *glVertex, v2 *glVertex, provoke uint64) {
					draw_triangle_line(v0, v1, v2, provoke)
				}(v0, v1, v2, provoke)
			}
		} else if face == GLenum(GL_BACK) {
			c.Poly_mode_back = mode
...
func PglCreateProgram(vertex_shader vert_func, fragment_shader frag_func, n GLsizei, interpolation *GLenum, fragdepth_or_discard GLboolean) GLuint {
	...
	libc.MemCpy(unsafe.Pointer(&tmp.Interpolation[0]), unsafe.Pointer(interpolation), int(uintptr(n)*unsafe.Sizeof(GLenum(0))))
	for i := int64(1); uint64(i) < c.Programs.Size; i++ {
		if (*(*glProgram)(unsafe.Add(unsafe.Pointer(c.Programs.A), unsafe.Sizeof(glProgram{})*uintptr(i)))).Deleted != 0 && i != int64(c.Cur_program) {
			*(*glProgram)(unsafe.Add(unsafe.Pointer(c.Programs.A), unsafe.Sizeof(glProgram{})*uintptr(i))) = tmp
...
func GlUseProgram(program GLuint) {
	...
	c.Vs_output.Size = (*(*glProgram)(unsafe.Add(unsafe.Pointer(c.Programs.A), unsafe.Sizeof(glProgram{})*uintptr(program)))).Vs_output_size
	cvec_reserve_float(&c.Vs_output.Output_buf, uint64(c.Vs_output.Size*MAX_VERTICES))
	c.Vs_output.Interpolation = &(*(*glProgram)(unsafe.Add(unsafe.Pointer(c.Programs.A), unsafe.Sizeof(glProgram{})*uintptr(program)))).Interpolation[0]
...
func pglSetInterp(n GLsizei, interpolation *GLenum) {
	(*(*glProgram)(unsafe.Add(unsafe.Pointer(c.Programs.A), unsafe.Sizeof(glProgram{})*uintptr(c.Cur_program)))).Vs_output_size = int64(n)
	c.Vs_output.Size = int64(n)
	libc.MemCpy(unsafe.Pointer(&(*(*glProgram)(unsafe.Add(unsafe.Pointer(c.Programs.A), unsafe.Sizeof(glProgram{})*uintptr(c.Cur_program)))).Interpolation[0]), unsafe.Pointer(interpolation), int(uintptr(n)*unsafe.Sizeof(GLenum(0))))
	cvec_reserve_float(&c.Vs_output.Output_buf, uint64(n*MAX_VERTICES))
	c.Vs_output.Interpolation = &(*(*glProgram)(unsafe.Add(unsafe.Pointer(c.Programs.A), unsafe.Sizeof(glProgram{})*uintptr(c.Cur_program)))).Interpolation[0]
}
func pglDrawFrame() {
	var frag_shader frag_func = (*(*glProgram)(unsafe.Add(unsafe.Pointer(c.Programs.A), unsafe.Sizeof(glProgram{})*uintptr(c.Cur_program)))).Fragment_shader
	for y := float32(0.5); y < float32(c.Back_buffer.H); y++ {
		for x := float32(0.5); x < float32(c.Back_buffer.W); x++ {
			c.Builtins.Gl_FragCoord.X = x
			c.Builtins.Gl_FragCoord.Y = y
			c.Builtins.Discard = GL_FALSE
			frag_shader(nil, &c.Builtins, (*(*glProgram)(unsafe.Add(unsafe.Pointer(c.Programs.A), unsafe.Sizeof(glProgram{})*uintptr(c.Cur_program)))).Uniform)
			if c.Builtins.Discard == 0 {
				draw_pixel(c.Builtins.Gl_FragColor, int64(x), int64(y))
			}
		}
...
func pglBufferData(target GLenum, size GLsizei, data unsafe.Pointer, usage GLenum) {
	...
	if (*(*glBuffer)(unsafe.Add(unsafe.Pointer(c.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr(c.Bound_buffers[target])))).User_owned == 0 {
		libc.Free(unsafe.Pointer((*(*glBuffer)(unsafe.Add(unsafe.Pointer(c.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr(c.Bound_buffers[target])))).Data))
	}
	(*(*glBuffer)(unsafe.Add(unsafe.Pointer(c.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr(c.Bound_buffers[target])))).Data = (*u8)(data)
	(*(*glBuffer)(unsafe.Add(unsafe.Pointer(c.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr(c.Bound_buffers[target])))).User_owned = GL_TRUE
	(*(*glBuffer)(unsafe.Add(unsafe.Pointer(c.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr(c.Bound_buffers[target])))).Size = size
...
func pglGetBufferData(buffer GLuint, data *unsafe.Pointer) {
	...
	if buffer != 0 && uint64(buffer) < c.Buffers.Size && (*(*glBuffer)(unsafe.Add(unsafe.Pointer(c.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr(buffer)))).Deleted == 0 {
		*data = unsafe.Pointer((*(*glBuffer)(unsafe.Add(unsafe.Pointer(c.Buffers.A), unsafe.Sizeof(glBuffer{})*uintptr(buffer)))).Data)
	} else if c.Error == 0 {
		c.Error = GLenum(GL_INVALID_OPERATION)
	}
}
